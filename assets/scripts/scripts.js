...
typewriter.typeString('hi, there!')
    ...
    .pauseFor(800)
    .deleteAll()
    .typeString("i'm a student at uc santa barabra (go gauchos!).")
    .pauseFor(500)
    .deleteAll()
    .typeString("i'm majoring in statistics and data science.")
    .pauseFor(500)
    .deleteAll()
    .typeString("i'm also interested in front-end development.")
    .pauseFor(500)
    .deleteAll()
